      ...
      <div className="lg:col-span-2">
        <div className="space-y-4">
          ...
          {Object.entries(cartDetails ?? {}).map(([id, entry]) => (
            <div key={id} className="grid grid-cols-4 gap-4 items-center bg-card p-4 rounded-lg shadow">
              <div className="flex items-center">
                ...
                <h3 className="ml-4 font-medium">{entry.name}</h3>
              </div>
              <span>{entry.project || 'N/A'}</span>
              <div className="flex items-center">
                <Button
                  variant="outline"
                  size="icon"
              ...
              <div className="flex items-center justify-between">
                <span className="font-medium">${(entry.price * entry.quantity).toFixed(2)}</span>
                <Button
                  variant="ghost"
